...
function csn_newsletter() {
   ...
   // echo 'Last Name *<br />';
    ...
    echo '<p>';
    //echo 'Email * <br />';
    echo '<input required style="width:200px;padding:7px;margin-top:0px;" type="email" name="csn-email" value="" size="40" placeholder="Email Address"/>';
    
    
    echo '<input type="hidden" name="custom_newsletter_nonce" value="'.wp_create_nonce('custom-newsletter-nonce').'"/>';
    echo '<input type="submit" name="csn-submitted" value="'.$button_label.'"/></p>';
    echo '</form>';
