...
class CHPCS {
	...
	foreach( $myposts as $post ){
		...
		if($display_title){
		$slider_gallery.= '<br/><span class="chpcs_title" style="text-align:left;"><a  style=" text-decoration:none;font-size: 14pt;font-weight:bold;" href="'.$post_link.'">'.$post_title.'</a></span><br/>';
		}

		if($display_excerpt){
		$slider_gallery.= '<p style="text-align:left;"><span class="chpcs_foo_con" style="font-weight:bold;color:#000">'.$this->wa_chpcs_clean($text_type, $word_limit).'</span></p>';
		}
